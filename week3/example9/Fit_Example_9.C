...
void FitExample9(){
    ...
    TCanvas *TestCanvas = new TCanvas ("TestCanvas","Fitting Test 9",0,0,1200,800);
    ...
    // Now we try it with the full function and no initial conditions.
    
    // The Combined Function will be over the range 0.->200., with 5 parameters
    ...
    TestCanvas->Print("Fit_Example_9.ps");
    TestCanvas->Print("Fit_Example_9.gif");
