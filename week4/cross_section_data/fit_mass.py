...
def fit_mass():
    ...
    xwidth = [hist.GetBinLowEdge(b+1)/1000-hist.GetBinLowEdge(b)/1000 for b in range(1, nbins+1)]
    ...
    test_canvas = TCanvas("TestCanvas", "Ds Fit", 0, 0, 700, 700)
