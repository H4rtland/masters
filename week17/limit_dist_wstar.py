...
root_file = TFile.Open("data/mjj_wstar_mc15_13TeV_361023_Pythia8EvtGen_A14NNPDF23LO_jetjet_JZ3W_total_final.root")
...
print(hist_bins, hist_model.GetNbinsX())
print("")
print([hist.GetBinLowEdge(b) for b in range(1, hist.GetNbinsX())])
print("")
print([hist_model.GetBinLowEdge(b) for b in range(1, hist_model.GetNbinsX())])
