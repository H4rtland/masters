...
int main() { // main program
  ...
  ofstream outputdata(
      "z.out"); // create a file to store the results you calculate.
  ...
  while (inputdata >> p1[0] >> p1[1] >> p1[2] >> e1 >> p2[0] >> p2[1] >>
         p2[2] >> e2) {

    // sum the 4-vectors

    // need to change this to calculate the mass.
    // Would also like you to calculate the PT of the Z (This should be the sum
    // of its px and py)
    double ez;
    double pz[3];
    ez = e1 + e2;
